...
/**
 * Admin Login — separate entry point from /login (lecturer/staff).
 *
 * Validates role = "admin" explicitly. A lecturer account entered here
 * is rejected with a clear message rather than redirected through,
 * keeping the two portals genuinely separate.
 */
export default function AdminLoginPage() {
  ...
  return (
    <div
      ...
      style={{ background: "radial-gradient(circle at top left, rgba(184,150,12,0.18), transparent 20%), radial-gradient(circle at bottom right, rgba(15,23,42,0.30), transparent 40%), #1B3D2B" }}
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full px-6 pb-10 md:py-10">
        <div className="w-full max-w-md">
          ...
          <div className="glass rounded-3xl p-6 md:p-8 shadow-2xl border-white/10">
            <h2 className="font-serif text-nictm-950 text-xl mb-6">Admin Sign In</h2>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                placeholder="admin@nictm.edu.ng"
                autoComplete="email"
              />
            </div>
